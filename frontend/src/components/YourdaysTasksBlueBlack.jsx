...
const YourDaysTasks = () => (
  <section className="font-madefor">
    <div className="mb-4 sm:mb-8 mt-2 grid grid-cols-3 grid-rows-2 gap-2 sm:flex sm:flex-row sm:flex-nowrap sm:items-center sm:gap-4 sm:overflow-x-auto">
      <h2
        className="col-span-2 row-span-1 text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white font-madefor mr-2 whitespace-nowrap sm:col-auto sm:row-auto"
        style={{
