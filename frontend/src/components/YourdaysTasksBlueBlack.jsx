...
const YourDaysTasks = () => (
  <section className="md:ml-14 xl:ml-6 ml-6 font-madefor mt-4">
    <div className="mb-4  mt-2 flex flex-wrap items-center gap-2">
      ...
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full bg-white border border-gray-200 text-[#2E4C73] font-semibold shadow-sm text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        All
      </button>
      <button className="flex-shrink-0 px-2 py-1 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border border-orange-400 text-orange-500 font-semibold flex items-center gap-1 sm:gap-2 bg-orange-50 text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        <span role="img" aria-label="fire" className="text-lg md:text-xl">
          🔥
        </span>
        Hot
      </button>
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border border-gray-200 text-gray-500 font-semibold bg-white text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        Due Today
      </button>
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border border-gray-200 text-gray-500 font-semibold bg-white text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        Over due
