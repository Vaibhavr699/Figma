...
const Navbar = () => {
  return (
    <nav className="w-full flex items-center justify-between px-2 md:px-4 bg-[#000000]">
      {/* Left: Logo */}
      ...
      <div className="relative flex-1 flex items-center justify-center">
        ...
        >
          <span className="text-black text-xs md:text-base lg:text-md font-semibold">
            Your Schedule
          </span>
      ...
      <div className="flex gap-1 items-center ml-2 xs:ml-4  z-30 pb-2  md:pt-4">
        <button className="relative w-6 h-6  md:h-10 md:w-10 lg:w-14 lg:h-14 flex items-center justify-center rounded-full bg-black border border-gray-800 hover:bg-gray-100 p-0">
          <span>
            <svg
              width="100%"
              height="100%"
        ...
        <div className="w-7 h-7 md:h-10 md:w-10 lg:w-14 lg:h-14 rounded-full bg-black flex items-center justify-center">
          <img
