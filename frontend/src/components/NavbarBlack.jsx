...
const Navbar = () => {
  return (
    <nav className="w-full flex items-center justify-between px-6 bg-[#000000]">
      {/* Left: Logo */}
      ...
      >
        {/* Black pill */}
        <div
          className="absolute left-1/2 -translate-x-1/2 flex items-center bg-[#ffffff] rounded-full px-3 sm:px-4 md:px-6 py-2 sm:py-3 min-w-[220px] sm:min-w-[300px] md:min-w-[600px] md:min-h-[70px] sm:min-h-[70px] lg:min-w-[1000px] lg:min-h-[70px] max-w-[95%] z-10"
          style={{ height: "48px", top: 0 }}
        >
          <span className="text-black text-xs sm:text-sm md:text-base lg:text-lg font-semibold ">
            Your Schedule
          </span>
          {/* Calendar Icon Section */}
          <div
            className="hidden sm:flex  items-center rounded-full border border-[#858789] bg-transparent
                      px-3 py-1.5 gap-2
          ...
          >
            {/* Icon Container */}
            <div
              className="flex items-center justify-center rounded-full bg-[#5e5062]
                         w-5 h-5
                         sm:w-4 sm:h-4
                         md:w-6 md:h-6"
            >
              <svg
                className="w-5 h-5 sm:w-6 sm:h-6 md:w-12 md:h-12 lg:w-9 lg:h-9"
                viewBox="0 0 24 24"
                fill="#112141"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        {/* Orange pill */}
        {/* Orange pill – Hidden on small screens */}
        <div
          className="hidden sm:flex absolute left-1/2 -translate-x-1/3 items-center bg-[#FF8300] rounded-full min-w-[180px] sm:min-w-[120px] sm:min-h-[70px] md:min-w-[500px] md:min-h-[70px] lg:min-w-[600px] lg:min-h-[70px] max-w-[80%] h-[40px] sm:h-[48px] z-20 mx-auto"
          style={{ top: 0 }}
        >
          {/* Main Inner Pill */}
          <div className="flex items-center bg-[#F1700C] shadow py-1 sm:py-2 gap-2 sm:gap-4 h-[28px] sm:h-[40px] md:h-[48px] rounded-full min-w-[160px] sm:min-w-[180px] md:min-w-[390px] max-w-[70%] z-30 ml-2 sm:ml-4">
            {/* Avatars */}
      ...
      <div className="flex items-center gap-3 xs:gap-4 sm:gap-6 ml-2 xs:ml-4 sm:ml-10 z-30 pb-2 xs:pb-3 sm:pb-4 md:pt-4">
        <button
          className="relative w-7 h-7 xs:w-9 xs:h-9 sm:w-11 sm:h-11 md:h-14 md:w-14 flex items-center justify-center rounded-full bg-white border border-gray-200 hover:bg-gray-100 p-0"
