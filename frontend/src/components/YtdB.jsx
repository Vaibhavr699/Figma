          ...
          >
            ...
            <div className="flex items-start justify-between px-2 pt-2 relative z-10">
              ...
              <div className="flex gap-1">
                <button className={`w-11 h-11 flex items-center justify-center rounded-full border ${isHighlight ? "border-[#D3DAE2] bg-[#222B36] text-[#2E4C73]" : "border-gray-200 bg-white text-gray-500"} shadow-sm`}><Bell className="w-5 h-5" /></button>
                <button className={`w-11 h-11 flex items-center justify-center rounded-full border ${isHighlight ? "border-[#D3DAE2] bg-[#222B36] text-[#2E4C73]" : "border-gray-200 bg-white text-gray-500"} shadow-sm`}><ArrowUpRight className="w-5 h-5" /></button>
              </div>
            </div>
