...
const YourDaysTasks = () => (
  <section className="md:ml-14 xl:ml-6 ml-6 font-madefor mt-4">
    <div className="mb-4  mt-2 flex flex-wrap items-center gap-2">
      <h2
        className="col-span-2 row-span-1 text-lg md:text-xl lg:text-2xl font-bold font-madefor mr-2 whitespace-nowrap sm:col-auto sm:row-auto text-white"
        style={{
      ...
      <button className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full border border-gray-200 bg-#080808 text-gray-500 hover:bg-gray-100 col-span-1 row-span-1 sm:col-auto sm:row-auto">
      ...
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px- md:py-3 md:min-w-[40px] rounded-full bg-white border border-gray-200 text-[#2E4C73] font-semibold shadow-sm text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        All
      </button>
      <button className="flex-shrink-0 px-2 py-1 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border  text-orange-500 font-semibold flex items-center gap-1 sm:gap-2 bg-#080808 text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        <span role="img" aria-label="fire" className="text-lg md:text-xl">
          🔥
        </span>
        Hot
      </button>
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border border-gray-200 text-gray-500 font-semibold bg-#080808 text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        Due Today
      </button>
      <button className="flex-shrink-0 px-3 py-1.5 min-w-[80px] sm:px-4 sm:py-2 sm:min-w-[100px] md:px-6 md:py-3 md:min-w-[110px] rounded-full border border-gray-200 text-gray-500 font-semibold bg-#080808 text-xs sm:text-sm md:text-base col-span-1 row-span-1 sm:col-auto sm:row-auto">
        Over due
        ...
        return (
          ...
          >
            ...
            <div className="flex items-start justify-between px-2 pt-2 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span
                    className={`text-xs  ${isHighlight ? "text-orange-100" : "text-[#7B8FA1]"}`}
                  >
                    {task.title}
                  </span>
                </div>
            ...
            <div className="flex items-center gap-4 px-6 pt-6 pb-2 relative z-10">
              <div
                className={`w-10 h-10   lg:w-14 lg:h-14 flex items-center justify-center rounded-full border ${isHighlight ? "border-orange-200 bg-orange-100/30" : "border-white bg-gray-50"}`}
              >
