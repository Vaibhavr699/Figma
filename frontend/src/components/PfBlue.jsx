  ...
  return (
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-[220px] sm:h-[270px] md:h-[280px] p-3 sm:p-5 bg-transparent overflow-hidden rounded-3xl transform transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:cursor-pointer">
      ...
      <div className="absolute top-3 right-1 z-10">
        <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full bg-#100C25 hover:bg-white hover:shadow-md hover:scale-105 transition-all duration-300 border border-gray-100">
      ...
      <div className="flex flex-col justify-end h-full pl-2 pt-16 sm:pt-20 pr-1 sm:pr-2 pb-1 sm:pb-2 z-10 relative">
        <h2
          className="text-white mb-1 text-lg sm:text-xl md:text-2xl lg:text-2xl"
          style={{
        ...
        <p className="text-xs sm:text-sm md:text-base text-[#fff] mb-4 sm:mb-4 truncate">
          {title}
        </p>
          ...
          <div>
            ...
            <div className="flex gap-1 sm:gap-2">
              {sources.includes("LinkedIn") && (
                <button className="flex items-center gap-1 px-2 sm:px-3 py-1 text-xs sm:text-sm bg-[#3C3658] rounded-full text-[#7B8FA1] font-medium">
                  LinkedIn
                </button>
              )}
              ...
              {sources.includes("Typeform") && (
                <button className="flex items-center gap-1 px-2 sm:px-3 py-1 text-xs sm:text-sm lg:text-sm bg-[#3C3658] rounded-full text-[#7B8FA1] font-medium">
                  Typeform
                </button>
              )}
            </div>
