  ...
  >
    ...
    />
      ...
      <div className="flex flex-wrap items-center gap-1 sm:gap-2 md:gap-4 lg:gap-6 ml-1 sm:ml-2 md:ml-4 min-w-0 w-full md:w-auto">
        <h1 className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl font-bold tracking-tight flex items-center font-manrope truncate max-w-[100px] xs:max-w-[140px] sm:max-w-[200px] md:max-w-[350px] lg:max-w-[500px]">
          <span className="inline-block align-middle mx-1">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-8 h-6 xs:w-10 xs:h-7 sm:w-20 sm:h-8 md:w-40 md:h-18 lg:w-60 lg:h-12"
            >
              <path
        ...
        <button className="flex items-center gap-2 sm:gap-3 md:gap-4 bg-black text-white py-1 px-2 sm:px-3 md:px-5 lg:px-6 rounded-full text-xs sm:text-sm md:text-md font-semibold ml-1 sm:ml-2 md:ml-4 lg:ml-6 shadow font-manrope whitespace-nowrap">
          {/* Icon */}
          <span className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-[#232323] flex items-center justify-center">
