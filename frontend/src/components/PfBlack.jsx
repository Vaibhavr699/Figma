          ...
          <div>
            ...
            <div className="flex gap-1 sm:gap-2">
              {sources.includes("LinkedIn") && (
                <button className="flex items-center gap-1 px-2 sm:px-3 py-1 text-xs sm:text-sm bg-[#080808] rounded-full text-[#7B8FA1] font-medium">
                  LinkedIn
                </button>
              )}
              ...
              {sources.includes("Typeform") && (
                <button className="flex items-center gap-1 px-2 sm:px-3 py-1 text-xs sm:text-sm lg:text-sm bg-[#080808] rounded-full text-[#7B8FA1] font-medium">
                  Typeform
                </button>
              )}
            </div>
