  ...
  return (
    <nav className="w-full flex items-center justify-between px-6 bg-[#100C25]" >
      ...
      <div className="relative flex-1 flex items-center justify-center" style={{ minWidth: 0 }}>
        ...
        <span className="text-black text-xs sm:text-sm md:text-base lg:text-lg font-semibold px-2">
            Your Schedule
          </span>
          ...
          <div
            className="hidden sm:flex items-center rounded-full border border-[#2D3238] bg-transparent
                      ...
                      md:px-1 
                      lg:px-3 lg:py-1 lg:gap-2
                      w-fit"
          >
            {/* Icon Container */}
            <div
              className="flex items-center justify-center rounded-full bg-[#d3bbe1]
                         w-5 h-5
                         sm:w-6 sm:h-6
                         md:w-9 md:h-9"
            >
            ...
            {/* Date Text */}
            <span className="text-black text-sm sm:text-base font-medium whitespace-nowrap">
              28 March
            </span>
            </div>
        ...
        {/* Orange pill */}
        <div className="hidden sm:flex absolute left-1/2 -translate-x-1/3 flex items-center mt-1 bg-blue-400 rounded-full min-w-[180px] sm:min-w-[120px] sm:min-h-[70px] md:min-w-[500px] md:min-h-[70px] lg:min-w-[600px] lg:min-h-[70px] max-w-[80%] h-[40px] sm:h-[48px] z-20 mx-auto" style={{ top: 0 }}>
          {/* Main Inner Pill (wider, but less than orange) */}
          <div className="hidden sm:flex flex items-center bg-blue-500 shadow py-1 sm:py-2 gap-2 sm:gap-4 h-[28px] sm:h-[40px] md:h-[48px] rounded-full min-w-[160px] sm:min-w-[100px] md:min-w-[390px] max-w-[70%] z-30 ml-2 sm:ml-4">
            {/* Avatars */}
