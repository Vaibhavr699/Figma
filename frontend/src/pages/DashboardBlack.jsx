...
import WorksAreaBlack from '../components/WorkAreaBlack.jsx';
import PfCard from '../components/PfBlack.jsx';
...
const interestColors = ["bg-gray-700", "bg-green-700", "bg-yellow-600", "bg-orange-600", "bg-red-700"];

const DashboardBlack = () => {
  return (
    <div className=" w-full bg-gradient-to-b bg-black">
      <NavbarBlack />
      <div className="flex px-2 items-start gap-x-8 mt-10">
        ...
        <nav className="hidden md:flex flex-col items-center gap-4 pt-1 px-2 mt-56 py-2">
          <button className="w-14 h-14 flex items-center justify-center rounded-full bg-white text-white shadow-lg">
            <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.5121 8.95408H11.8958C11.4572 8.95408 11.0935 8.59036 11.0935 8.15175C11.0935 7.71315 11.4572 7.34943 11.8958 7.34943H17.5121C17.9507 7.34943 18.3144 7.71315 18.3144 8.15175C18.3144 8.59036 17.9614 8.95408 17.5121 8.95408Z" fill="#2e4c73"/>
              <path d="M6.27874 9.76711C6.07548 9.76711 5.87222 9.69222 5.71176 9.53176L4.90943 8.7294C4.5992 8.41917 4.5992 7.90568 4.90943 7.59545C5.21967 7.28521 5.73315 7.28521 6.04339 7.59545L6.27874 7.8308L8.11874 5.99079C8.42897 5.68056 8.94246 5.68056 9.2527 5.99079C9.56296 6.30103 9.56296 6.81451 9.2527 7.12475L6.84571 9.53176C6.69595 9.68153 6.49269 9.76711 6.27874 9.76711Z" fill="#2e4c73"/>
              <path d="M17.5121 16.4425H11.8958C11.4572 16.4425 11.0935 16.0787 11.0935 15.6401C11.0935 15.2015 11.4572 14.8378 11.8958 14.8378H17.5121C17.9507 14.8378 18.3144 15.2015 18.3144 15.6401C18.3144 16.0787 17.9614 16.4425 17.5121 16.4425Z" fill="#2e4c73"/>
              <path d="M6.27874 17.2555C6.07548 17.2555 5.87222 17.1806 5.71176 17.0201L4.90943 16.2178C4.5992 15.9075 4.5992 15.3941 4.90943 15.0838C5.21967 14.7736 5.73315 14.7736 6.04339 15.0838L6.27874 15.3192L8.11874 13.4792C8.42897 13.1689 8.94246 13.1689 9.2527 13.4792C9.56296 13.7894 9.56296 14.3029 9.2527 14.6131L6.84571 17.0201C6.69595 17.1699 6.49269 17.2555 6.27874 17.2555Z" fill="#2e4c73"/>
              <path d="M14.7093 23H8.29071C2.48186 23 0 20.5182 0 14.7093V8.29071C0 2.48186 2.48186 0 8.29071 0H14.7093C20.5182 0 23 2.48186 23 8.29071V14.7093C23 20.5182 20.5182 23 14.7093 23ZM8.29071 1.60465C3.35907 1.60465 1.60465 3.35907 1.60465 8.29071V14.7093C1.60465 19.641 3.35907 21.3954 8.29071 21.3954H14.7093C19.641 21.3954 21.3954 19.641 21.3954 14.7093V8.29071C21.3954 3.35907 19.641 1.60465 14.7093 1.60465H8.29071Z" fill="#2e4c73"/>
            </svg>
          </button>
          <button className="w-14 h-14 flex items-center justify-center rounded-full bg-[#052659] text-[#7B8FA1] shadow-lg border border-gray-100">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-2 md:gap-4 mb-2 sm:mb-4 mt-1">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row gap-2 md:gap-3 ml-0 sm:ml-2 md:ml-4 py-2 md:py-0">
                ...
                <div className="flex flex-row flex-wrap gap-1 sm:gap-2 md:gap-3">
                  <button className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 min-w-[40px] sm:min-w-[48px] md:min-w-[56px] flex items-center justify-center rounded-full border border-gray-200 bg-[#000000] text-gray-500 hover:bg-gray-100"><Search className="w-4 h-4 sm:w-5 sm:h-5" /></button>
                  <button className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 min-w-[40px] sm:min-w-[48px] md:min-w-[56px] flex items-center justify-center rounded-full border border-gray-200 bg-[#000000] text-gray-500 hover:bg-gray-100"><Filter className="w-4 h-4 sm:w-5 sm:h-5" /></button>
                ...
                <div className="flex flex-row flex-wrap gap-1 sm:gap-2 md:gap-3 md:ml-0">
                  <button className="flex-shrink-0 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-3 min-w-[110px] sm:min-w-[130px] md:min-w-[150px] rounded-full border border-gray-200 text-[#2E4C73] font-semibold bg-[#000000] text-xs sm:text-sm md:text-base">Great interest</button>
                  <button className="flex-shrink-0 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-3 min-w-[110px] sm:min-w-[130px] md:min-w-[150px] rounded-full border border-gray-200 text-[#2E4C73] font-semibold bg-[#000000] text-xs sm:text-sm md:text-base hidden md:block">Medium interest</button>
                  <button className="flex-shrink-0 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-3 min-w-[110px] sm:min-w-[130px] md:min-w-[150px] rounded-full border border-gray-200 text-[#2E4C73] font-semibold bg-[#000000] text-xs sm:text-sm md:text-base hidden lg:block">Low interest</button>
                  <button className="flex-shrink-0 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-3 min-w-[110px] sm:min-w-[130px] md:min-w-[150px] rounded-full border border-gray-200 text-[#2E4C73] font-semibold bg-[#000000] text-xs sm:text-sm md:text-base hidden lg:block">Non interest</button>
                </div>
              </div>
            </div>
