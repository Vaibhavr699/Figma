    ...
    <div className=" w-full bg-gradient-to-b from-gray-100 to-white">
      ...
      <div className="flex px-2 items-start gap-x-8 mt-8">
        ...
        <nav className="hidden md:flex flex-col fixed items-center gap-4 pt-1 px-2 lg:mr-4 mt-56 py-2">
          <button className="w-14 h-14 flex items-center justify-center rounded-full bg-[#052659] text-white shadow-lg transition-all duration-200 hover:bg-[#1B3B6F] hover:shadow-2xl hover:scale-105">
          ...
          <button className="w-14 h-14 flex items-center justify-center rounded-full bg-white text-[#7B8FA1] shadow-lg border border-gray-100 transition-all duration-200 hover:bg-[#F3F6FA] hover:shadow-2xl hover:scale-105">
