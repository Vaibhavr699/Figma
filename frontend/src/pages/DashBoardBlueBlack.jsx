...
const interestColors = ["bg-gradient-to-br from-[#23243A] to-[#1C0A6B]", "bg-green-700", "bg-yellow-600", "bg-orange-600", "bg-red-700"];
        ...
        <main className="flex-1">
          ...
          <section className="mb-8">
            <div className="flex items-center gap-6 mb-4 mt-1">
              <h2 className="text-3xl font-bold font-manrope text-white">New Leads</h2>
              <span className="text-lg font-semibold font-manrope underline underline-offset-4 decoration-2 decoration-white flex items-end"><span className="text-white">7 Leads</span></span>
              {/* Pills and icons */}
              <div className="flex items-center gap-3 ml-4">
                {/* Search Icon */}
                <button className="w-10 h-10 flex items-center justify-center rounded-full border border-[#23243A] bg-[#1C0A6B] text-white hover:bg-[#23243A]"><Search className="w-5 h-5" /></button>
                {/* Filter Icon */}
                <button className="w-10 h-10 flex items-center justify-center rounded-full border border-[#23243A] bg-[#1C0A6B] text-white hover:bg-[#23243A]"><Filter className="w-5 h-5" /></button>
                {/* Pills */}
                <button className="px-5 py-2 rounded-full bg-[#1C0A6B] border border-[#23243A] text-white font-semibold shadow-sm">All</button>
                <button className="px-5 py-2 rounded-full border border-[#23243A] text-white font-semibold flex items-center gap-2 "><span role='img' aria-label='fire'>🔥</span>Hot Client</button>
                <button className="px-5 py-2 rounded-full border border-[#23243A] text-white font-semibold bg-[#1C0A6B]">Great interest</button>
                <button className="px-5 py-2 rounded-full border border-[#23243A] text-white font-semibold bg-[#1C0A6B]">Medium interest</button>
                <button className="px-5 py-2 rounded-full border border-[#23243A] text-white font-semibold bg-[#1C0A6B]">Low interest</button>
                <button className="px-5 py-2 rounded-full border border-[#23243A] text-white font-semibold bg-[#1C0A6B]">Non interest</button>
              </div>
            </div>
