...
const ProjectDashboard = () => {
  ...
  const ProjectCard = ({ project }) => (
    <div className="bg-white rounded-lg p-4 mb-6 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
  ...
  return (
    <div className="min-h-screen bg-[#F5EDE3]">
      ...
      <main className="p-6">
        ...
        <div className="flex space-x-6 mb-10 bg-[#F5EDE3]">
          {tabs.map((tab) => (
            <button
              key={tab}
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  <div className={`w-3 h-3 rounded-full ${
                    ...
                    column.title === 'InProgress' ? 'bg-blue-500' :
